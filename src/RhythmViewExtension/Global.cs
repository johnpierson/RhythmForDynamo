...
namespace RhythmViewExtension
{
    internal class Global
    {
        ...
        internal static string HumanizerDll => Path.Combine(PackageBinFolder, "Humanizer.dll");
        internal static string MarkovDll => Path.Combine(PackageBinFolder, "Markov.dll");
